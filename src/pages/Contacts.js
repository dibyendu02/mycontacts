    ...
    <div className="flex flex-col gap-5 items-center bg-black min-h-screen">
      ...
      <div className="flex flex-col gap-5">
        {contacts.map((contact) => (
          <div
            key={contact._id}
            className="flex  items-center gap-10 bg-slate-200 w-[80vw] p-2 rounded-md"
          >
            <div>
              <img src={user} />
            </div>
      ...
      {isOpen && (
        <div
          ref={ref}
          className="bg-slate-200 absolute flex flex-col gap-5 items-center w-[90%] p-5 rounded-md"
        >
          <input
            onChange={(e) => {
